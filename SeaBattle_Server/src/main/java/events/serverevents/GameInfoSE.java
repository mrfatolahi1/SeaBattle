...
public class GameInfoSE extends ServerEvent{
    ...
    public GameInfoSE(BoardsInfoSE boardsInfo_se, String player1Username, String player2Username, int player1Score, int player2Score, boolean yourTurn, boolean update) {
